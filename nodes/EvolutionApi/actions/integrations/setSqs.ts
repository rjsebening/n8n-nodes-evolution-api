...
export async function setSqs(this: IExecuteFunctions, index: number): Promise<any> {
	...
	const response = await apiRequest.call(this, 'POST', `/sqs/set/${instanceName}`, body as unknown as IDataObject);
